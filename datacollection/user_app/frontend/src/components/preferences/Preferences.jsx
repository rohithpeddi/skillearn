			...
			<div className="content">
				...
				<div className="selection">
					...
					<div className="environment-selection">
						{userData && userData.recording_schedules && userData.recording_schedules[environment] && userData.recording_schedules[environment].normal ? (
							<ActivityTable
								activityIdList={userData.recording_schedules[environment].normal}
								activities={activities}
					...
					<div className="environment-selection">
						{userData && userData.recording_schedules && userData.recording_schedules[environment] && userData.recording_schedules[environment].mistakes ? (
							<ActivityTable
								activityIdList={userData.recording_schedules[environment].normal}
								activities={activities}
								label={"Normal Activities"}
