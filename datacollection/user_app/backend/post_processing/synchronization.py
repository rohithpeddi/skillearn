			...
			for stream_name in self.synchronize_streams:
				if stream_name == const.DEPTH_AHAT:
					...
					depth_pose_file_path = os.path.join(depth_parent_directory,
					                                    f'{self.recording.id}_depth_ahat_pose.pkl')
					...
					depth_data_directory = os.path.join(depth_parent_directory, const.DEPTH)
					synchronized_depth_data_directory = os.path.join(synchronized_depth_parent_directory, const.DEPTH)
					...
					depth_ab_directory = os.path.join(depth_parent_directory, const.AB)
					synchronized_depth_ab_directory = os.path.join(synchronized_depth_parent_directory, const.AB)
					...
					spatial_file_path = os.path.join(spatial_directory,
					                                 f'{self.recording.id}_spatial.pkl')
					...
					logger.error(f"Cannot synchronize {stream_name} data with PV as base stream")
					continue
