...
class RecordingDataContainer:
	...
	def to_dict(self):
		return {
			...
			const.DATA_JSON: self.recording_data_json
		}
	...
	def from_dict(cls, recording_data_container_dict) -> "RecordingDataContainer":
		...
		recording_data_container.GOPRO_RESOLUTION_360p = data_json[const.GOPRO][
			const.RESOLUTION_360P]
		recording_data_container.GOPRO_RESOLUTION_4k = data_json[const.GOPRO][const.RESOLUTION_4K]
		
		if recording_data_container.is_holo_lens_enabled:
