...
class HololensServiceTest:
    ...
    def _receive_pv(self):
        ...
        pv_client = hl2ss.rx_pv(self.device_ip, pv_port, hl2ss.ChunkSize.PHOTO_VIDEO,
								hl2ss.StreamMode.MODE_1, FRAME_WIDTH, FRAME_HEIGHT, FRAMERATE, VIDEO_PROFILE_DECODED,
								VIDEO_BITRATE)
    ...
    def _receive_vlc(self, vlc_port):
        ...
        vlc_client = hl2ss.rx_rm_vlc(self.device_ip, vlc_port,
    ...
    def _init_params(self, rec: Recording):
        ...
        try:
            self.async_storage_map = {
                ...
                hl2ss.StreamPort.RM_DEPTH_AHAT: mp.Pool(4),
